 ...
 * @author vukof
 */
public class fromMonHoc extends javax.swing.JFrame {

    /**
     * Creates new form fromMonHoc
     */
    public fromMonHoc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtMaMon = new javax.swing.JTextPane();
        jScrollPane7 = new javax.swing.JScrollPane();
        txtSoTC = new javax.swing.JTextPane();
        jScrollPane8 = new javax.swing.JScrollPane();
        txtTenMon = new javax.swing.JTextPane();
        ...
        jLabel7.setText("Số TC");

        jLabel8.setText("Tên Lớp");

        jScrollPane3.setPreferredSize(new java.awt.Dimension(64, 25));

        txtMaMon.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                txtMaMonAncestorAdded(evt);
            }
        ...
        tableHienThi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Ma Mon", "Ten Mon", "So TC", "M Khoa"
            }
        ));
    ...
    private void txtMaMonAncestorAdded(javax.swing.event.AncestorEvent evt) {                                       
        // TODO add your handling code here:
    }                                      

    private void btnXemDiemActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
...
private void HienThiDanhSach(){
     DefaultTableModel tableModel = (DefaultTableModel) tableHienThi.getModel();
        ...
        tableModel.addColumn("Ten Lop");
        tableModel.addColumn("So TC");
        tableModel.addColumn("M Khoa");
        int stt = 0;
        for(MonHoc lop: ql.DocFile("MonHoc.txt")) {
            stt++;
            tableModel.addRow(new Object[] {stt,lop.getMaMon(),lop.getTenMon(),lop.getSoTc(),lop.getMaKhoa()});
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
             ql.setData(ql.DocFile("MonHoc.txt"));
        MonHoc sv = new MonHoc();
        sv.setMaMon(txtMaMon.getText());
        sv.setTenMon(txtTenMon.getText());
        sv.setSoTc(Integer.parseInt(txtSoTC.getText()));
        sv.setMaKhoa(combo.getSelectedItem().toString());
        ql.Themdata(sv);
        ql.GhiFile("monhoc.txt");
  ...
  sv.setMaKhoa(combo.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fromMonHoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextPane txtMaMon;
    private javax.swing.JTextPane txtSoTC;
    private javax.swing.JTextPane txtTenMon;
